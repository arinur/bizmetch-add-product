...
class RetailPricePage extends StatefulWidget {
  static String tag = "retail-price-page";
  @override
  RetailPricePageState createState() => RetailPricePageState();
}

class RetailPricePageState extends State<RetailPricePage> {
